...
public class AccountTest {
    public static void main(String[] args) {
        ...
        double withdrawAmount = input.nextDouble(); // obtém a entrada do usuário1
        System.out.printf("%nwithdrawing %.2f from account1 balance%n%n", withdrawAmount);
        account1.withdraw(withdrawAmount); // retira do saldo de account1

        System.out.println("Enter withdraw amount for account2: ");// prompt
        withdrawAmount = input.nextDouble(); // obtém a entrada do usuário2
        System.out.printf("%nwithdrawing %.2f from account2 balance%n%n", withdrawAmount);
        account2.withdraw(withdrawAmount); // retira do saldo de account2
